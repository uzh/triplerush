...
//
////  lazy val genStarQuery: Gen[QuerySpecification] = for {
////      i <- arbitrary(genSubjectPattern)
////      h <- oneOf(value(empty), genStarQuery)
////    } yield h.extend(i)
////  }
//
...
//          TriplePattern(-1, 1, 2),
//          TriplePattern(-1, 3, -2))).toParticle
//        qp.writeQueryId(id)
//        qp.queryId == id
//      },
//      minSuccessful(100))
...
//        val qp = QuerySpecification(patterns).toParticle
