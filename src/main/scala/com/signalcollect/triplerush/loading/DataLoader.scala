...
case class DataLoader(filePathOrInputStream: Either[String, InputStream], dictionary: Dictionary, lang: Lang = Lang.TURTLE) extends Iterator[GraphEditor[Long, Any] => Unit] {
